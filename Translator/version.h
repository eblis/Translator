...
*/
#ifndef M_TRANSLATOR_VERSION_H
#define M_TRANSLATOR_VERSION_H
...
#define __DESC                  "Tries to retrieve all translatable strings in Miranda."
...
#define __PLUGIN_DISPLAY_NAME   "Translator (x64)"
#else
#define __PLUGIN_DISPLAY_NAME   "Translator"
#endif

#endif //M_TRANSLATOR_VERSION_H
